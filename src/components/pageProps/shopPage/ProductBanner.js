...
const ProductBanner = ({ itemsPerPageFromBanner }) => {
  return (
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
      {/* Left Part Start here */}
      {/* <div className="flex items-center gap-4">
        <span className="bg-primeColor text-white w-8 h-8 text-lg flex items-center justify-center cursor-pointer">
          <BsGridFill />
        </span>
        <span className="border-[1px] border-gray-300 text-[#737373] w-8 h-8 text-base flex items-center justify-center cursor-pointer">
          <ImList />
        </span>
      </div> */}
      {/* Left Part End here */}
